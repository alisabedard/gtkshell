...
static void gsh_delete_GSHCommandShell(GSHCommandShell * this)
{
	g_free(this);
}

static GtkWidget *get_command_shell(GSHCommandShell * this)
{
	return this->widgets.row;
}

static void run_command(GSHCommandShell * this, const gchar * command)
{
	gchar *result;
...
static void setup_command_shell_methods(GSHCommandShell * this)
{
...
static void set_output_label_options(GtkWidget * output)
{
...
static void setup_output_scroller(GtkWidget * row, GtkWidget * output)
{
	GtkWidget *scroller;
...
static void setup_output_area(GSHCommandShell * this)
{
	GtkWidget *output;
...
static void setup_command_shell_widgets(GSHCommandShell * this)
{
...
static void setup_command_shell(GSHCommandShell * this)
{
